class expr:
    ...
    def deriv(self, x):
        ...
        if self.variable():
            ...
            return self.makediv(self.makesub(self.makemul(e1.deriv(x), e2), self.makemul(e1, e2.deriv(x))),
                                self.makemul(e2, e2))
            ...
            raise Exception("И что с тобой делать?!")


a = input("Введите меня, пожалуйста: ")
e = expr(a)
e.prettyprint()
f = e.deriv('x')
f.prettyprint()
